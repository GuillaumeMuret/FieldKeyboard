/*
 * @file FieldKeyboardException.java
 * @brief Exception used for analyse the user entry
 *
 * @version 1.0
 * @date 20/07/2017
...
public class FieldKeyboardException extends Exception{
    public FieldKeyboardException(String fieldKeyboardMessage) {
        super(fieldKeyboardMessage);
    }
}

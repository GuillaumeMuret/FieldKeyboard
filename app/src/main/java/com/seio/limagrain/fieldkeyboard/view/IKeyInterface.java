/*
 * @file IKeyInterface.java
 * @brief Interface of the keys displayed on the keyboard
 *
 * @version 1.0
 * @date 20/07/2017
...
public interface IKeyInterface {
    ...
    // Called when the user click on a key
    void onKeyPressed(CustomKeyView customKeyView);

    // Called when the user click long time on a key
    void onKeyLongPressed(CustomKeyView customKeyView);
